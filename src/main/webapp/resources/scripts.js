...
function processSearch(root, currentPage) {
    ...
    if (shipType !== "Any") {
        suffix += "&shipType=" + shipType.toUpperCase();
    }
    if (yearAfter !== "") {
        suffix += "&after=" + yearAfter;
    }
    if (yearBefore !== "") {
        suffix += "&before=" + yearBefore;
    }
    if (isUsed !== null) {
        suffix += "&isUsed=" + isUsed;
    }
    if (speedMin !== "") {
        suffix += "&minSpeed=" + speedMin;
    }
    if (speedMax !== "") {
        suffix += "&maxSpeed=" + speedMax;
    }
    if (crewSizeMin !== "") {
        suffix += "&minCrewSize=" + crewSizeMin;
    }
    if (crewSizeMax !== "") {
        suffix += "&maxCrewSize=" + crewSizeMax;
    }
    if (ratingMin !== "") {
        suffix += "&minRating=" + ratingMin;
    }
    if (ratingMax !== "") {
        suffix += "&maxRating=" + ratingMax;
    }
